...
def solve(problem):
    ...
    # if verbose:
    #     print("\nSOLVER(): Attempting to satisfy the problem...")
    #     print("=======================================================================")
    ...
    is_sat = r_solve(truth_values, partial, 0, problem.clauses, vars, problem.verbose)

    # if verbose:
    #     print("SOLVER(): Returning", is_sat)
    #     print("=======================================================================")
